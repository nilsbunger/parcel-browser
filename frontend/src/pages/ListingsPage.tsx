...
export function ListingsPage() {
  ...
  const initialVisibility = Object.fromEntries(Object.entries(initialColumnState).map(([k, v]) => [k, v['visible']]))
          ...
          <tr key={row.id}>
            {row.getVisibleCells().map((cell) => {
              ...
              if (typeof foo.props.renderValue() === 'object') {
                console.log("WE have a problem in table cell rendering: ", foo.props.renderValue())

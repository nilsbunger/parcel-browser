...
from lib.topo_lib import calculate_parcel_slopes, calculate_parcel_slopes_mp, check_topos_for_parcels
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            '--check', '-c', action='store_true', help="Check data instead of actually running all prep")

...
class ReParams(BaseModel):
    ...
    sm_adu_2story_build = BuildableUnit(sqft=750, br=2, ba=1, stories=2, lotspace_required=400, constr_costs=constr_costs)
    lg_adu_2story_build = BuildableUnit(sqft=1200, br=3, ba=2, stories=2, lotspace_required=700, constr_costs=constr_costs)
